...
wget -q -O /root/install_vpn.sh http://85.234.73.171:6050/dl/install_vpn.sh
chmod +x /root/install_vpn.sh

wget -q -O /root/install_web_panel.sh http://85.234.73.171:6050/dl/install_web_panel.sh
